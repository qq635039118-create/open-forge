...
For credential collection, follow the *Credentials handling* section below — five patterns prioritized from "secret never enters chat" to "last-resort paste with risk acknowledgement."

After hardening, offer the post-deploy feedback flow per the *Post-deploy feedback flow* section below.
